...
<body>
     <form action="/ser/project/createreportprojectdatestart" method="post">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Relatorio De Projetos A Partir De Uma Data De Inicio </h4>
                                </div>
                            </div>
                            <div class="panel-body">							
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="date" name = "sProjectDateStart" autocomplete = "off" maxlength="10" id= "dataTermino"    required   class="form-control "/>
