...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        GERENCIAR TIPOS DE REQUISITOS</h4>
                                </div>
                            </div>
			...
			<tr>
				<th colspan="10" align="center">TIPOS DE REQUISITOS</th>
			</tr>
			...
			<tr>
				...
				?>	
							<tr>
								<td align="center"> <?= $oTypeRequirement['idTipoRequisito'];?> </td>
								<td align="center"> <?= $oTypeRequirement['nomeTipoRequisito'];?> </td>
								<td align="center"> <?= $oTypeRequirement['obsTipoRequisito'];?> </td>
				
								<td align="center"> <a href="/ser/requirement/edittyperequirement/<?= $oTypeRequirement['idTipoRequisito']?>">Editar  </a>
								<a  href="/ser/requirement/removetyperequirement/<?= $oTypeRequirement['idTipoRequisito'] ?> ">Deletar</a> </td>
							</tr>
				<?php
						}
					}
