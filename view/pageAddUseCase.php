...
<body>
    <form action="/ser/case/addusecase" method="post">
		<?php
     ...
     <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Diagrama</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                           ...
                           <div class="panel-body">
							   <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <select name = "iIdDiagram" autocomplete = "off" class="form-control">
											<?php
												foreach($aAllDiagram as $aDiagram)
												{
											?>		
											 <option value= '<?=  $aDiagram['idDiagrama'] ?>'><?=  $aDiagram['nomeDiagrama'] ?></option>
											<?php
												}
											?>
                                ...
                                <div class="control-group col-md-7">
                                    ...
                                    <div class="controls">
										<input type="text" name ="sUseCaseName" autocomplete = "off" required class="form-control"/>
								...
								<br/>
								 <div class="control-group col-md-6">
                                    <label>
                                       ...
                                       <div class="controls">
											<textarea class="ckeditor" rows="4" cols="70" autocomplete = "off" name ="sUseCaseFlow"> </textarea>
                                       </div>
                                </div>
								 ...
								 <div class="control-group col-md-6">
                                    <label>
                                        Resumo</label>
                                       <div class="controls">
											<textarea class="ckeditor" rows="4" cols="40" autocomplete = "off" name ="sUseCaseResume"> </textarea>
											<br />
										</div>
								</div>
                                <div class="control-group col-md-6">
                                    <label>
                                        Pre-Condicao</label>
                                        <div class="controls">
												<textarea class="ckeditor" rows="4" autocomplete = "off" cols="50" name ="sUseCasePrecondition"> </textarea>
											<br />
										</div>
								</div>
								<br/>
                                 <div class="control-group col-md-6">
                                    <label>
                                        Pos-Condicao </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" cols="40"  autocomplete = "off" name ="sUseCasePoscondition" > </textarea>
                                        <br />
                                    </div>
                                </div>
								</br>
								...
								<div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" cols="50" autocomplete = "off" name ="sUseCaseAlternativeFlow"> </textarea>
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-6">
                                    <label>
                                        Excecoes </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" cols="50" autocomplete = "off" name ="sUseCaseException"> </textarea>
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" cols="50" autocomplete = "off" name ="sUseCaseBusinessRule"> </textarea>
                                        <br />
                                    </div>
                                </div>
                                    <br />
