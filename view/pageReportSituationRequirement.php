...
<body>
     <form action="/ser/requirement/createallreportsituationrequirement" method="post">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Relatorio De Requisitos Por Situacao</h4>
                                </div>
                            </div>
                            <div class="panel-body">
								...
								<div class="control-group col-md-4">
                                    <label>
                                        Situacao</label>
                                    <div class="controls">
                                        <select name = "sSituationRequirement" autocomplete = "off" class="form-control">										
