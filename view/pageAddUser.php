...
<body>
    <form action="/ser/user/adduser" method="post">
		<?php
                            ...
                            <div class="panel-body">
                                ...
                                <div class="control-group col-md-6">
                                 ...
                                 <div class="control-group col-md-4">
                                    <label>
                                        CPF</label>
                                    <div class="controls">
                                        <input type="text" name ="sUserCpf" autocomplete = "off" class="form-control" maxlength="14" id= "cpf" onKeyUp="formataCPF(cpf,event)" required/>
                                        <br />
                                    </div>
                                </div>
								</br>
								<div class="control-group col-md-3">
                                    <label>
                                        Email</label>
                                    <div class="controls">
                                        <input type="email" name ="sUserEmail" autocomplete = "off" class="form-control" required/>
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-3">
                                    <label>
                                        Senha</label>
                                    <div class="controls">
                                        <input type="password" name ="sUserPassword" autocomplete = "off" class="form-control" required/>
                                        <br />
                                    </div>
                                </div>
