...
<body>
     <form action="/ser/task/createreporttaskproject" method="post">
	 <?php
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Relatorio De Tarefas Por Projeto</h4>
                                </div>
                            </div>
                            <div class="panel-body">							
								<div class="control-group col-md-4">
                                    <label>
                                        Projeto</label>
                                    <div class="controls">
                                        <select name = "iProjectId" autocomplete = "off" class="form-control">
											<?php
												foreach($aAllProject as $aProject)
												{
											?>		
											 <option value= '<?=  $aProject['idProjeto'] ?>'><?=  $aProject['nomeProjeto'] ?></option>
											<?php
												}
											?>
