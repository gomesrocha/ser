<?php
	...
	$aAllManager = Project::reportManagerProject();	
?>
...
<body>
     <form action="/ser/requirement/createallreportrequirementperiod" method="post">
					  ...
					  <li class="nav-header">
                       ...
                       <ul class="list-unstyled collapse in" id="Ul1">
                            ...
                            <li><i class="glyphicon glyphicon-list-alt"></i>  Requisito</li>
								<ul>
								<li>
									<a href="/ser/requirement/createallreportrequirement"><i class="glyphicon glyphicon-print"></i> Todos os Requisitos </a></li>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Relatorio De Requisitos Por Periodo</h4>
                                </div>
                            </div>
                            <div class="panel-body">							
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="date" name = "sStartDateRequirement" autocomplete = "off" maxlength="10" id= "dataInicio"    required   class="form-control "/>
								...
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="date" name = "sFinishDateRequirement" autocomplete = "off" maxlength="10" id= "dataTermino"    required   class="form-control "/>
