...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">TAREFAS</th>
			</tr>
			...
			<tr>
				...
				<td  align="center">Tarefa Dependente</td>
			...
			<tr>
				...
				?>	
							<tr>
								...
								<td align="center"> <?= $oTask['nomeTarefa'];?> </td>
								<td align="center"> <?= $oDepTask['nomeTarefa']   ;?> </td>
								<td align="center"> <?= $oTask['dataInicioTarefa'];?> </td>
								<td align="center"> <?= $oTask['dataTerminoTarefa'];?></td>
				
								<td align="center"> <a href="/ser/task/edittask/<?= $oTask['idTarefa'] ?>">Editar  </a>
								<a  href="/ser/task/removetask/<?= $oTask['idTarefa'] ?> ">Deletar</a> </td>
							</tr>
				<?php
