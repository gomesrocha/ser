...
<body>
    <form action="/ser/user/updateuser" method="post">
		<?php
			$aAllUserNotManager 	 = User::allUserNotLink();
        ...
        <div class="row">
			...
			<tr>
				...
				<?php
				    ...
				    if(!empty($aAllUserNotManager))
				    {	
						foreach ($aAllUserNotManager as $oUser) 
						{	
				...
				?>	
							<tr>
								...
								<td align="center"> <a href="/ser/user/addlink/<?= $oUser['idUsuario']?>">Vincular  </a>
							</tr>
				<?php
