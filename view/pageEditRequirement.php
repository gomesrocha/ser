                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
							   <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <select name = "iRequirementType" class="form-control">
											<?php
												foreach($aAllTypeRequirement as $oTypeRequirement)
												{
											?>		
											<option  <?php echo $oEditRequirement['TipoRequisito_idTipoRequisito'] == $oTypeRequirement['idTipoRequisito'] ? 'selected':'';?> value="<?= $oTypeRequirement['idTipoRequisito']?>"> <?= $oTypeRequirement['nomeTipoRequisito']?></option>
											<?php
												}
											?>
                                ...
                                <div class="control-group col-md-6">
                                    <label>
                                        Tarefa</label>
                                    <div class="controls">
                                        <select name = "iRequirementTask" class="form-control">
											<?php
												foreach($aAllTask as $oTask)
												{
											?>		
											 <option  <?php echo $oEditRequirement['Tarefa_idTarefa'] == $oTask['idTarefa'] ? 'selected':'';?> value="<?= $oTask['idTarefa']?>"> <?= $oTask['nomeTarefa']?></option>
											<?php
												}
											?>
								  ...
								  <div class="control-group col-md-4">
                                    <label>
                                        Projeto</label>
                                    <div class="controls">
                                        <select name = "iRequirementProject" class="form-control">
											
											<?php
												foreach($aAllProject as $oProject)
												{
											?>		
											 <option  <?php echo $oEditRequirement['Projeto_idProjeto'] == $oProject['idProjeto'] ? 'selected':'';?> value="<?= $oProject['idProjeto']?>"> <?= $oProject['nomeProjeto']?></option>
											<?php
												}
											?>
                                ...
                                <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <input type="text"   name = "sRequirementName" autocomplete = "off" required class="form-control" value ='<?php echo $oEditRequirement['nomeRequisito'] ?>' />
								...
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" readonly="true"  name = "sRequirementDateStart" autocomplete = "off" required class="form-control" value ='<?php echo $oEditRequirement['dataInicioRequisito'] ?>'/>
								...
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text"   name = "sRequirementDateFinish" autocomplete = "off"  maxlength="10" id= "dataTermino" onKeyUp="formataData(dataTermino,event)" required class="form-control" value ='<?php echo $oEditRequirement['dataTerminoRequisito'] ;?>' />							
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-4">
                                    <label>
                                       Importancia</label>
                                   <div class="controls">
                                        <select name = "sImportanceRequirement" class="form-control">
											 <option value='Baixa' <?php echo $oEditRequirement["importanciaRequisito"]=='Baixa'?'selected':'';?>>Baixa</option>
											 <option value='Media' <?php echo $oEditRequirement["importanciaRequisito"]=='Media'?'selected':'';?>>Media</option>
											 <option value='Alta' <?php echo $oEditRequirement["importanciaRequisito"]=='Alta'?'selected':'';?>>Alta</option>
										</select>
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-4">
                                    <label>
                                        Situacao</label>
                                    <div class="controls">
                                        <select name = "sRequirementSituation" autocomplete = "off" class="form-control">
											
											<option value="avaliacao" <?php echo $oEditRequirement["situacaoRequisito"]=='avaliacao'?'selected':'';?>>Avaliação</option>
											<option value="aprovado" <?php echo $oEditRequirement["situacaoRequisito"]=='aprovado'?'selected':'';?>>Aprovado</option>
											<option value="desenvolvimento" <?php echo $oEditRequirement["situacaoRequisito"]=='desenvolvimento'?'selected':'';?>>Desenvolvimento</option>
											<option value="atrasado" <?php echo $oEditRequirement["situacaoRequisito"]=='atrasado'?'selected':'';?>>Atrasado</option>
											<option value="finalizado" <?php echo $oEditRequirement["situacaoRequisito"]=='finalizado'?'selected':'';?>>Finalizado</option>
										</select>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-6">
                                    <label>
                                        Descricao</label>
                                    <div class="controls">
                                         <textarea class="ckeditor" rows="12" cols="61" required autocomplete = "off" name ="sDescriptionRequirement" > <?php echo $oEditRequirement["descricaoRequisito"]?></textarea>
                                    ...
                                    <div class="controls">
                                        <div class="control-group col-md-12">
											...
											<div class="controls">
												<input type="submit" name = "btnAdd" class="btn btn-primary" value="Alterar"/>
