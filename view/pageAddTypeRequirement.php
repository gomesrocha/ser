...
<body>
    <form action="/ser/requirement/addtyperequirement" method="post">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Cadastrar Tipos de Requisito</h4>
                                </div>
                            </div>
                                ...
                                <div class="control-group col-md-7">
                                 ...
                                 <div class="control-group col-md-6">
                                    <label>
                                        Obs </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="12" cols="61" autocomplete = "off" required  name ="sRequirementObs" > </textarea>
                                        <br />
                                    </div>
                                </div>
								</br>
