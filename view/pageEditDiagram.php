...
<body>
    <form action="/ser/diagram/updatediagram" method="post">
		<?php
			$oEditDiagram = Diagram::findEditDiagram();
			$oEditProject = Project::findProject($oEditDiagram['Projeto_idProjeto']); 
			$oEditActor   = Actor::findActor($oEditDiagram['Ator_idAtor']); 
			$aAllProject  = Project::allUserProject();
			$aAllActor    = Actor::allActor();
		?>
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="controls">
                                        <select id="projectId" name = "sProjectId"  class="form-control">
											<?php
												...
												{
											?>
												<option  <?php echo   $oProject['idProjeto'] == $oEditProject['idProjeto'] ? 'selected':'';?> value="<?= $oProject['idProjeto'] ?>"> <?= $oProject['nomeProjeto'] ?></option>
                                ...
                                <div class="control-group col-md-6">
                                    <label>
                                        Nome do Ator </label>
                                    <div class="controls">
                                        <select id="actorId" name = "iActorId" class="form-control">
											
											<?php
												
												foreach($aAllActor as $oActor )
												{
											?>
											<option  <?php  $oActor['idAtor'] == $oEditActor['idAtor'] ? 'selected':'';?> value="<?=$oActor['idAtor']?>"> <?=  $oEditActor['nomeAtor'] ?></option>
                                 ...
                                 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="sDiagramName" autocomplete = "off" class="form-control" value="<?=$oEditDiagram['nomeDiagrama']?>" required/>
                                        <br />
                                    </div>
                                </div>
								</br>
								<div class="control-group col-md-3">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="sDiagramImagePath" autocomplete = "off" class="form-control"  value="<?=$oEditDiagram['imgDiagrama']?>" required/>
                                        <br />
                                    </div>
                                </div>
                                    <br />
