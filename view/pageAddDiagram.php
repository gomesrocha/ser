...
<body>
    <form action="/ser/diagram/adddiagram" method="post">
		<?php
                            ...
                            <div class="panel-body">
                                ...
                                <div class="control-group col-md-6">
                                    <label>
                                        Nome do Ator </label>
                                    <div class="controls">
                                        <select id="actorId" name = "iActorId" autocomplete = "off" class="form-control">
											...
											<?php
												...
												{
											?>
											<option value= '<?=  $oActor['idAtor'] ?>'><?=  $oActor['nomeAtor'] ?></option>
                                 ...
                                 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="sDiagramName" autocomplete = "off" class="form-control" required/>
                                        <br />
                                    </div>
                                </div>
								</br>
								<div class="control-group col-md-3">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="sDiagramImagePath" autocomplete = "off" class="form-control" required/>
                                        <br />
                                    </div>
                                </div>
                                    <br />
