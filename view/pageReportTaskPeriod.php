...
<body>
     <form action="/ser/task/createreporttaskperiod" method="post">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Relatorio De Tarefas Por Periodo</h4>
                                </div>
                            </div>
                            <div class="panel-body">							
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="date" name = "sTaskDateStart" autocomplete = "off" maxlength="10" id= "dataInicio"    required   class="form-control "/>
								...
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="date" name = "sTaskDateFinish" autocomplete = "off" maxlength="10" id= "dataTermino"    required   class="form-control "/>
