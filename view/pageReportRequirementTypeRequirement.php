...
<body>
     <form action="/ser/requirement/createallreportrequirementtyperequirement" method="post">
	<?php
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Relatorio De Requisitos Por Tipo</h4>
                                </div>
                            </div>
                            <div class="panel-body">							
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <select name = "iIdTypeRequirement" autocomplete = "off" class="form-control">
											<?php
												foreach($aAllTypeRequirement as $aRequirement)
												{
											?>		
											 <option value= '<?=  $aRequirement['idTipoRequisito'] ?>'><?=  $aRequirement['nomeTipoRequisito'] ?></option>
											<?php
												}
											?>
