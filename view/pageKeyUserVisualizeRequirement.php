...
<body>
    <form action="/ser/requirement/situationupdaterequirement" method="post">
		<?php
			...
			$aRequirement = Requirement::findKeyUserRequirement();
		?>
							   ...
							   <div class="control-group col-md-6">
								...
								<div class="control-group col-md-4">
                                    <label>
                                        Situacao</label>
                                    <div class="controls">
                                        <select name = "sRequirementSituation" autocomplete = "off" class="form-control" readonly="true">
								 ...
								 <div class="control-group col-md-6">
                                    ...
                                    <br />
									 <div class="control-group col-md-8">
										<label>
											Requisito Aprovado ?</label>
										<div class="controls">
											<INPUT TYPE="RADIO" NAME="sSituationRequirement" VALUE="aprovado"> SIM</input>
											<INPUT TYPE="RADIO" NAME="sSituationRequirement" VALUE="reprovado"> NAO </input>
										</div>
									</div>
									<br/>
                                    <br />
                                   ...
                                   <br/>
											<div class="controls">
												<input type="submit" name = "btnAdd" class="btn btn-primary" value="Confirmar"/>
