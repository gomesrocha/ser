...
<body>
    <form action="/ser/requirement/addrequirement" method="post">
		<?php
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
							   <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <select name = "iRequirementType" autocomplete = "off" class="form-control">
											<?php
                                ...
                                <div class="control-group col-md-6">
								  ...
								  <div class="control-group col-md-4">
                                    <label>
                                        Projeto</label>
                                    <div class="controls">
                                        <select name = "iRequirementProject" autocomplete = "off" class="form-control">
                                ...
                                <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <input type="text"   name = "sRequirementName" autocomplete = "off" required class="form-control" />
								...
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" readonly="true"  name = "sRequirementDateStart" autocomplete = "off" required class="form-control" value='<?php echo date('d/m/Y'); ?>'/>
								...
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text"   name = "sRequirementDateFinish" autocomplete = "off" maxlength="10" id= "dataTermino" onKeyUp="formataData(dataTermino,event)" required class="form-control" />
								...
								<div class="control-group col-md-4">
                                    <label>
                                       Importancia</label>
                                   <div class="controls">
                                        <select name = "sImportanceRequirement" autocomplete = "off" class="form-control">
								...
								<div class="control-group col-md-4">
								 ...
								 <div class="control-group col-md-6">
                                    <label>
                                        Descricao</label>
                                    <div class="controls">
                                         <textarea class="ckeditor" rows="12" cols="61" required autocomplete = "off"  name ="sDescriptionRequirement" > </textarea>
