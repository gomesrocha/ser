...
<body>
     <form action="/ser/user/createreportdateinclusionusers" method="post">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Relatorio De Usuarios A Partir De Data De Inclusao</h4>
                                </div>
                            </div>
                            <div class="panel-body">							
								<div class="control-group col-md-4">
                                    <label>
                                        Data de Inclusão</label>
                                    <div class="controls">
                                        <input type="date" name = "sDateInclusionUsers" autocomplete = "off" maxlength="10" id= "datainclusao"    required   class="form-control "/>
