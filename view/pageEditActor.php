...
<body>
    <form action="/ser/actor/updateactor" method="post">
		<?php
			$oEditActor	 = Actor::findEditActor(); 
		?>
     ...
     <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Ator</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-7">
                                    <label>
                                       Nome do Ator</label>
                                    <div class="controls">
										<input type="text" name ="sActorName" autocomplete = "off" required class="form-control" value="<?=$oEditActor['nomeAtor']?>"/>
                                    </div>
                                </div>
                                 <div class="control-group col-md-6">
                                    <label>
                                        Descricao do Ator </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="12" autocomplete = "off" cols="61" required  name ="sActorDescription"  > <?=$oEditActor['descAtor']?></textarea>
                                        <br />
                                    </div>
                                </div>
								</br>
