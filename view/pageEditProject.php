...
<body>
    <form action="/ser/project/updateproject" method="post">
		<?php
			$oEditProject = Project::findEditProject();
			$aAllManager  = User::viewAllManager();
		?>
     ...
     <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Projetos</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
								<div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <select  name = "iManager" class="form-control">
											
											<?php
												foreach($aAllManager as $oManager )
												{
											?>
											 
											<option  <?php echo $oEditProject['Usuario_idUsuario'] == $oManager['idUsuario'] ? 'selected':'';?> value="<?=$oManager['idUsuario']?>"> <?= $oManager['nomeUsuario']?></option>
                                ...
                                <div class="control-group col-md-7">
                                    <label>
                                        Nome</label>
                                    <div class="controls">
										<input type="text" name ="sProjectName" autocomplete = "off" required class="form-control" value="<?php echo $oEditProject["nomeProjeto"] ?>"/>
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    <label>
                                        Status</label>
                                    <div class="controls">
                                        <select name = "sProjectStatus" class="form-control">
											
											<option value="avaliacao" <?php echo $oEditProject["statusProjeto"]=='avaliacao'?'selected':'';?>>Avaliação</option>
											<option value="aprovado" <?php echo $oEditProject["statusProjeto"]=='aprovado'?'selected':'';?> >Aprovado</option>
											<option value="desenvolvimento" <?php echo $oEditProject["statusProjeto"]=='desenvolvimento'?'selected':'';?>>Desenvolvimento</option>
											<option value="atrasado" <?php echo $oEditProject["statusProjeto"]=='atrasado'?'selected':'';?>>Atrasado</option>
											<option value="finalizado" <?php echo $oEditProject["statusProjeto"]=='finalizado'?'selected':'';?>>Finalizado</option>
										</select>
                                        <br />
                                    </div>
                                </div>
                                <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" readonly="true" autocomplete = "off"  name = "sProjectDateStart" required class="form-control" value='<?php echo $oEditProject['dataInicioProjeto']; ?>'/>
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name = "sProjectDateConclusion" autocomplete = "off" required class="form-control" maxlength="10" id= "dataTermino" onKeyUp="formataData(dataTermino,event)" value = '<?php echo $oEditProject['dataTerminoProjeto'] ;?>'/>
                                 ...
                                 <div class="control-group col-md-6">
                                    <label>
                                        Visão Geral do Projeto </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="12" cols="61" autocomplete = "off" required  name ="sProjectOverview"> <?php echo $oEditProject['visaoGeralProjeto']; ?> </textarea>
                                        <br />
                                    </div>
                                </div>
								</br>
								...
								<div class="control-group col-md-6">
                                    <label>
                                        Questionario(OPCIONAL) </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" autocomplete = "off" cols="50" name ="sQuestionnaireProject"> <?php echo $oEditProject['questionarioProjeto']?> </textarea>
                                        <br />
                                    </div>
                                </div>
                                    <br />
                                    ...
                                    <div class="controls">
                                        <div class="control-group col-md-12">
											...
											<div class="controls">
												<input type="submit" name = "btnEdit" class="btn btn-primary" value="Alterar"/>
