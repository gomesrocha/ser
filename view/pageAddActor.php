...
<body>
    <form action="/ser/actor/addactor" method="post">
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-7">
                                    <label>
                                       Nome do Ator</label>
                                    <div class="controls">
										<input type="text" name ="sActorName" autocomplete = "off" required class="form-control"/>
                                    </div>
                                </div>
                                 <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="12" autocomplete = "off" cols="61" required  name ="sActorDescription" > </textarea>
                                        <br />
                                    </div>
                                </div>
								</br>
