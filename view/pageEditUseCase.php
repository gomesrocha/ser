...
<body>
    <form action="/ser/case/updateusecase" method="post">
		<?php
			$oEditUseCase = UseCase::findEditUseCase();
			$aAllDiagram  = Diagram::allDiagram();
		?>
     ...
     <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Caso de Uso</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                           ...
                           <div class="panel-body">
							   <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <select name = "iIdDiagram" class="form-control">
											<?php
												foreach($aAllDiagram as $oDiagram)
												{
											?>		
											 <option  <?php echo $oDiagram['idDiagrama'] == $oEditUseCase['Diagrama_idDiagrama'] ? 'selected':'';?> value="<?=$oDiagram['idDiagrama']?>"> <?=$oDiagram['nomeDiagrama']?></option>
											<?php
												}
											?>
                                ...
                                <div class="control-group col-md-7">
                                    <label>
                                        Nome do Caso de Uso</label>
                                    <div class="controls">
										<input type="text" name ="sUseCaseName" autocomplete = "off" value = "<?= $oEditUseCase['nomeCasoDeUso'] ?>" required class="form-control"/>
								 ...
								 <div class="control-group col-md-6">
                                    <label>
                                        Fluxo Principal</label>
                                       <div class="controls">
											<textarea class="ckeditor" rows="4" cols="50" autocomplete = "off" name ="sUseCaseFlow"><?= $oEditUseCase['fluxoCasoDeUso'] ?> </textarea>
                                       </div>
                                </div>
								 ...
								 <div class="control-group col-md-6">
                                    <label>
                                        Resumo</label>
                                       <div class="controls">
											<textarea class="ckeditor" rows="4" cols="40" autocomplete = "off" name ="sUseCaseResume"> <?= $oEditUseCase['resumoCasoDeUso'] ?></textarea>
											<br />
										</div>
								</div>
                                <div class="control-group col-md-6">
                                    <label>
                                        Pre-Condicao</label>
                                        <div class="controls">
												<textarea class="ckeditor" rows="4" cols="50" autocomplete = "off" name ="sUseCasePrecondition"> <?= $oEditUseCase['precondicaoCasoDeUso'] ?> </textarea>
											<br />
										</div>
								</div>
								<br/>
                                 <div class="control-group col-md-6">
                                    <label>
                                        Pos-Condicao </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" cols="40" autocomplete = "off"  name ="sUseCasePoscondition" > <?= $oEditUseCase['posCondicaoCasoDeUso'] ?> </textarea>
                                        <br />
                                    </div>
                                </div>
								</br>
								...
								<div class="control-group col-md-6">
                                    <label>
                                        Fluxo Alternativo </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" cols="50" autocomplete = "off" name ="sUseCaseAlternativeFlow"><?= $oEditUseCase['fluxoAltCasoDeUso'] ?> </textarea>
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-6">
                                    <label>
                                        Excecoes </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" cols="50" name ="sUseCaseException"> <?= $oEditUseCase['excecaoCasoDeUso'] ?> </textarea>
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-6">
                                    <label>
                                        Regra de Negocio </label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" cols="50" autocomplete = "off" name ="sUseCaseBusinessRule"><?= $oEditUseCase['regraNegocioCasoDeUso'] ?> </textarea>
                                        <br />
                                    </div>
                                </div>
                                    <br />
