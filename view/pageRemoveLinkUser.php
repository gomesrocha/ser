...
<body>
    <form action="/ser/user/updateuser" method="post">
		<?php
			$aAllUsersLinkProject 	 = Project::allUsersLinkProject(); 
		?>
    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">USUARIOS</th>
			</tr>
			...
			<tr>
				...
				<?php
				    ...
				    if(!empty($aAllUsersLinkProject))
				    {	
						foreach ($aAllUsersLinkProject as $oUser) 
						{	
				...
				?>	
							<tr>
								...
								<td align="center"> <a href="/ser/user/removelinkuser/<?= $oUser['idUsuario']?>">Desvincular  </a>
							</tr>
				<?php
