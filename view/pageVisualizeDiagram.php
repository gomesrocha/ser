    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">DIAGRAMAS</th>
			</tr>
			...
			<tr>
				...
				?>	
							<tr>
								...
								<td align="center"> <?= $oDiagram['nomeDiagrama'];?> </td>
								<td align="center"> <?= $oProject['nomeProjeto'];?> </td>
								<td align="center"> <?= $oActor['nomeAtor'];?> </td>
								<td align="center"> <?= $oDiagram['imgDiagrama'];?> </td>
								<td align="center"> <a href="/ser/diagram/editdiagram/<?= $oDiagram['idDiagrama']?>">Editar  </a>
								<a  href="/ser/diagram/removediagram/<?= $oDiagram['idDiagrama'] ?> ">Deletar</a> </td>
							</tr>
				<?php
						}
					}					
