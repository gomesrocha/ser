...
<body>
    <form action="/ser/task/addtask" method="post">
		<?php
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="controls">
										<select id="userName" name = "iUserId" autocomplete = "off" class="form-control">
												...
												<?php
													...
													{
												?>
												<option value= '<?=  $oUser['idUsuario'] ?>'><?=  $oUser['nomeUsuario'] ?></option>
								...
								<div class="control-group col-md-7">
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                          <input type="text" name = "sTaskName" autocomplete = "off" required class="form-control"/>
                                        <br />
                                    </div>
                                </div>
                                <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" readonly="true" autocomplete = "off"  name = "sTaskDateStart" required class="form-control" value='<?php echo date('d/m/Y'); ?>'/>
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name = "sTaskDateConclusion" autocomplete = "off" maxlength="10" id= "dataTermino" onKeyUp="formataData(dataTermino,event)" required class="form-control"/>
                                 ...
                                 <div class="control-group col-md-6">
                                    <label>
                                       Observacao</label>
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="12" cols="61" autocomplete = "off" required  name ="sTaskObs"> </textarea>
                                        <br />
                                    </div>
                                </div>
								</br>
