			...
			<tr>
				...
				?>	
							<tr>
								...
								<td align="center"> <a href="/ser/requirement/editrequirement/<?= $oRequirement['idRequisito']?>">Editar  </a>
								<a  href="/ser/requirement/removerequirement/<?= $oRequirement['idRequisito'] ?> ">Deletar</a> </td>
							</tr>
				<?php
