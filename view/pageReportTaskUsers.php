...
<body>
     <form action="/ser/task/createreporttaskuser" method="post">
	 <?php
			$aAllUsers = User::allUser(); 
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Relatorio De Tarefas Por Usuario</h4>
                                </div>
                            </div>
                            <div class="panel-body">							
								<div class="control-group col-md-4">
                                    <label>
                                        Usuario</label>
                                    <div class="controls">
                                        <select name = "iUserId" autocomplete = "off" class="form-control">
											<?php
												foreach($aAllUsers as $aUser)
												{
											?>		
											 <option value= '<?=  $aUser['idUsuario'] ?>'><?=  $aUser['nomeUsuario'] ?></option>
											<?php
												}
											?>
