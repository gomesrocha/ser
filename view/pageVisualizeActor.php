    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">ATORES</th>
			</tr>
			...
			<tr>
				...
				?>	
							<tr>
								<td align="center"> <?= $oActor['idAtor'];?> </td>
								<td align="center"> <?= $oActor['nomeAtor'];?> </td>
								<td align="center"> <?= $oActor['descAtor'];?> </td>
								<td align="center"> <a href="/ser/actor/editactor/<?= $oActor['idAtor']?>">Editar  </a>
								<a  href="/ser/actor/removeactor/<?= $oActor['idAtor'] ?> ">Deletar</a> </td>
							</tr>
				<?php
						}
					}					
