...
<body>
    <form action="/ser/project/addproject" method="post">
		<?php
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
							   <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <select name = "iManager" autocomplete = "off" class="form-control">
											<?php
												foreach($aAllManager as $oManager)
												{
											?>		
											 <option value= '<?=  $oManager['idUsuario'] ?>'><?=  $oManager['nomeUsuario'] ?></option>
											<?php
												}
											?>
                                ...
                                <div class="control-group col-md-7">
                                    <label>
                                        Nome</label>
                                    <div class="controls">
										<input type="text" name ="sProjectName" autocomplete = "off" required class="form-control"/>
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    <label>
                                        Status</label>
                                    <div class="controls">
                                        <select name = "sProjectStatus" autocomplete = "off" class="form-control">
                                ...
                                <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" readonly="true" autocomplete = "off"  name = "sProjectDateStart" required class="form-control" value='<?php echo date('d/m/Y'); ?>'/>
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name = "sProjectDateConclusion" autocomplete = "off" maxlength="10" id= "dataTermino" onKeyUp="formataData(dataTermino,event)"   required   class="form-control "/>
                                 ...
                                 <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="12" cols="61" required autocomplete = "off"  name ="sProjectOverview" > </textarea>
                                        <br />
                                    </div>
                                </div>
								</br>
								...
								<div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                       <textarea class="ckeditor" rows="4" cols="50" autocomplete = "off" name ="sQuestionnaireProject"> </textarea>
                                        <br />
                                    </div>
                                </div>
                                    <br />
