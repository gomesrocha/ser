                ...
                <ul class="list-unstyled">
                    <li class="nav-header">
                        ...
                        <ul class="list-unstyled collapse in" id="userMenu">
						    <li class="active"><a href="pagedefaultstakeholder"><i class="glyphicon glyphicon-home"></i> Home</a></li>
                        </ul>
                    </li>
                    <hr />
                    ...
                    <li class="nav-header">
                        ...
                        <ul class="list-unstyled collapse in" id="Ul1">
                            <li><a href="pagevisualizeliftingstakeholder"><i class="glyphicon glyphicon-eye-open"></i>Acompanhar Levantamento</a></li>
                        </ul>
                    </li>
			...
			<tr>
				...
				?>	
							<tr>
								...
								<td align="center"> <a href="/ser/project/allstakeholderrequirementsproject/<?= $oProject['idProjeto']?>">Visualizar  </a> </td>
							</tr>
				<?php
						}
					}
